	...
	function jardiwinery_template_team_3_output($post_options, $post_data) {
		...
		?>
			<div<?php echo !empty($post_options['tag_id']) ? ' id="'.esc_attr($post_options['tag_id']).'"' : ''; ?>
				...
				<div class="sc_team_item_avatar"><?php jardiwinery_show_layout($post_options['photo']); ?>
					<div class="sc_team_item_hover">
						<div class="sc_team_item_socials"><?php jardiwinery_show_layout($post_options['socials']); ?></div>
					</div>
				</div>
				<div class="sc_team_item_info">
					...
					<div class="sc_team_item_position"><?php jardiwinery_show_layout($post_options['position']);?></div>
				</div>
			</div>
		<?php
