...
if ( !function_exists( 'jardiwinery_theme_setup' ) ) {
	...
	function jardiwinery_theme_setup() {
        ...
        //jardiwinery_storage_set('demo_data_url',  esc_url(jardiwinery_get_protocol() . '://demofiles.ancorathemes.com/jardiwinery/'));
	}
}
    ...
    function jardiwinery_importer_set_options( $options=array() ) {
        if ( is_array( $options ) ) {
            ...
            if ( is_dir( JARDIWINERY_THEME_PATH . 'demo/' ) ) {
                $options['demo_url'] = ARDIWINERY_THEME_PATH . 'demo/';
            } else {
            ...
            // Default demo
            $options['files']['default']['title'] = esc_html__( 'Education Demo', 'jardiwinery' );
            $options['files']['default']['domain_dev'] = esc_url(jardiwinery_get_protocol().'://jardi.dv.ancorathemes.com'); // Developers domain
            $options['files']['default']['domain_demo']= esc_url(jardiwinery_get_protocol().'://jardiwinery.ancorathemes.com'); // Demo-site domain
