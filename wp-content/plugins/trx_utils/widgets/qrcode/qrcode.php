...
class jardiwinery_widget_qrcode extends WP_Widget {
	...
	function form($instance) {
		...
		<div class="widget_qrcode">
            ...
            <div id="<?php echo esc_attr($this->get_field_id('qrcode_image')); ?>" class="qrcode_image"><img src="<?php jardiwinery_show_layout($instance['image']); ?>" alt="" /></div>
...
<?php if ($instance['show_personal']==1) { ?>
				...
				<?php if ($instance['show_what']==1) { ?>
					...
					?>
				<?php } else { ?>
                    <li class="text odd first"><?php jardiwinery_show_layout($instance['text']); ?></li>
				<?php } ?>
                </ul>
<?php } ?>
            </div>
